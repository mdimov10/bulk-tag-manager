    ...
    const handleInstallSnippet = async () => {
        ...
        try {
            ...
            if (res.data?.updated_files !== undefined && res.data?.total_files !== undefined) {
                ...
                if (updated_files === 0) {
                    setMessage("Dual pricing installation failed. It seems the app doesnt support your theme currently.");
        ...
        <Page fullWidth>
            <Layout>
                ...
                {installFailed && (
                  <Layout.Section>
                    <Banner status="warning" tone="warning" title="Installation Failed">
                      <p>We couldn’t inject the code into your theme. It seems the app doesnt support your theme currently.</p>
                    </Banner>
                  </Layout.Section>
                )}
                ...
                <Layout.Section>
                  <Banner
                      status="info"
                      title="Using Shrine or Shrine Pro?"
                      tone="info"
                      style={{ marginTop: '1rem' }}
                    >
                      <p>
                        If you're using the <strong>Shrine</strong> theme, please make sure your theme name is exactly one of:
                        <br />
                        <code>shrine</code> <br /> <code>shrine-theme</code>
                      </p>
                      <p style={{ marginTop: '0.5rem' }}>
                        If you're using <strong>Shrine Pro</strong>, the name should be:
                        <br />
                        <code>shrine-pro</code> <br /> <code>shrine-theme-pro</code>
                      </p>
                      <p style={{ marginTop: '0.5rem' }}>
                        You can check and rename your theme under <strong>Online Store → Themes → Actions → Rename</strong>.
                      </p>
                    </Banner>
                </Layout.Section>
