import {Card, Layout, Page, Button, Frame, Toast, Text, Link, Select, Checkbox, Banner} from "@shopify/polaris";
...
const SettingsPage = () => {
    ...
    useEffect(() => {
        ...
        //         setCheckoutNoticeEnabled(res.data.show_checkout_notice);
        //     } catch (err) {
                  ...
                  <Card title="Show EUR Total in Order Confirmation Email" sectioned>
                    ...
                    <div style={{ marginTop: '2rem', padding: '1rem', backgroundColor: '#f6f6f7', borderRadius: '8px' }}>
                      ...
                      <ol style={{ paddingLeft: '1.25rem', marginTop: '1rem' }}>
                        <li>
                          Download the complete email template:
                        ...
                        <li>
                          Click <strong>Edit code</strong> and <u>replace the entire content</u> with the one you just downloaded
                        </li>
                        <li>
