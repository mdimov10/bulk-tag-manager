...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_themes,write_themes,read_locales'),
...
//            \App\Listeners\CleanUpOnUninstall::class,
        ],
...
//            'address' => config('app.url').'/webhook/customers/data_request',
//            'method' => 'POST',
//        ],
//        [
//            'topic' => 'customers/redact',
//            'address' => config('app.url').'/webhook/customers/redact',
//            'method' => 'POST',
//        ],
//        [
//            'topic' => 'shop/redact',
//            'address' => config('app.url').'/webhook/shop/redact',
//            'method' => 'POST',
//        ],
    ],
